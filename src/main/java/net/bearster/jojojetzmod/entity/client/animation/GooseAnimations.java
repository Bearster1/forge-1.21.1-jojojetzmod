...
public class GooseAnimations {
    public static final AnimationDefinition GOOSE_IDLE_ANIMATION = AnimationDefinition.Builder.withLength(1f).looping()
            .addAnimation("tail",
    ...
    public static final AnimationDefinition GOOSE_WALKING_ANIMATION = AnimationDefinition.Builder.withLength(1f).looping()
            .addAnimation("R",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
