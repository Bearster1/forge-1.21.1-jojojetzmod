...
public class JoJoPikminAnimations {

    public static final AnimationDefinition JOJO_PIKMIN_WALKING_ANIMATION = AnimationDefinition.Builder.withLength(1f).looping()
            .addAnimation("leaf",
    ...
    public static final AnimationDefinition JOJO_PIKMIN_IDLE_ANIMATION = AnimationDefinition.Builder.withLength(1f).looping()
            .addAnimation("leaf",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
