...
public class JoJoLinkEntity extends Animal implements NeutralMob {
    ...
    public JoJoLinkEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.JOJO_LINK.get().create(serverLevel);
    }
    ...
    @Override
    public void tick() {
        JoJoLinkEntity.this.setTarget(null);
        super.tick();
